...
V0.6 月球车当前使用用户提供的 `web/public/月球车_写实贴图.glb`，旧文件 `月球车_居中无背景.glb` 保留。来源和授权详情待提供者补充，不归入 NASA 素材。写实版元数据注明贴图为 AI 生成美术图集。文件保持原样，展示尺寸与轨迹是示意；校验和及技术边界见 `../docs/V0.6月球车轨迹漫游.md`。
